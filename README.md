...
## Status
This is a **Phase 0–9** build: project setup, docs, testing foundation,
...
Sustainability Advisor, the deterministic Action Plan engine, and
authentication/privacy (real accounts, sessions, and one persisted slice —
saved properties + GreenScore history) are implemented. **The AI Advisor's
